...
class pt extends I {
  constructor(t) {
    ...
    super({ type: I.types.CONVEXPOLYHEDRON }),
      (this.vertices = e),
      (this.faces = s),
      (this.faceNormals = i),
  ...
  findSeparatingAxis(t, e, s, i, n, o, r, l) {
    ...
    const w = this;
    if (w.uniqueAxes)
      for (let g = 0; g !== w.uniqueAxes.length; g++) {
        s.vmult(w.uniqueAxes[g], c);
        const f = w.testSepAxis(c, t, e, s, i, n);
        if (f === !1) return !1;
        f < y && ((y = f), o.copy(c));
      }
    else {
      const g = r ? r.length : w.faces.length;
      for (let f = 0; f < g; f++) {
        const b = r ? r[f] : f;
    ...
    for (let g = 0; g !== w.uniqueEdges.length; g++) {
      s.vmult(w.uniqueEdges[g], h);
  ...
  clipFaceAgainstHull(t, e, s, i, n, o, r) {
    ...
    for (let B = 0; B < N; B++) {
      ...
      F.vsub(M, c),
        ...
        s.vmult(m, m),
        e.vadd(m, m);
      const v = k.connectedFaces[B];
      u.copy(this.faceNormals[v]);
      const P = this.getPlaneConstantOfFace(v);
      y.copy(u), s.vmult(y, y);
      const T = P - y.dot(e);
      for (this.clipFaceAgainstPlane(f, b, y, T); f.length; ) f.shift();
    ...
    for (let B = 0; B < f.length; B++) {
      ...
      if (
        ...
        const M = f[B];
        if (F <= 1e-6) {
          const v = { point: M, normal: y, depth: F };
          r.push(v);
        }
      }
    }
...
class z extends ve {
  constructor(t) {
    ...
    (this.mass = e),
      ...
      (this.type = e <= 0 ? z.STATIC : z.DYNAMIC),
      typeof t.type == typeof z.STATIC && (this.type = t.type),
      (this.allowSleep = typeof t.allowSleep < "u" ? t.allowSleep : !0),
      (this.sleepState = z.AWAKE),
  ...
  wakeUp() {
    ...
    (this.sleepState = z.AWAKE),
      (this.wakeUpAfterNarrowphase = !1),
      t === z.SLEEPING && this.dispatchEvent(z.wakeupEvent);
  }
  sleep() {
    (this.sleepState = z.SLEEPING),
  ...
  sleepTick(t) {
    if (this.allowSleep) {
      ...
      e === z.AWAKE && s < i
        ? ((this.sleepState = z.SLEEPY),
          (this.timeLastSleepy = t),
          this.dispatchEvent(z.sleepyEvent))
        : e === z.SLEEPY && s > i
        ? this.wakeUp()
        : e === z.SLEEPY &&
          t - this.timeLastSleepy > this.sleepTimeLimit &&
          (this.sleep(), this.dispatchEvent(z.sleepEvent));
    }
  }
  updateSolveMassProperties() {
    this.sleepState === z.SLEEPING || this.type === z.KINEMATIC
      ? ((this.invMassSolve = 0),
  ...
  applyForce(t, e) {
    if ((e === void 0 && (e = new a()), this.type !== z.DYNAMIC)) return;
  ...
  integrate(t, e, s) {
    if (
      ...
      !(this.type === z.DYNAMIC || this.type === z.KINEMATIC) ||
        this.sleepState === z.SLEEPING)
    )
      return;
    ...
    const u = p.elements,
      ...
      g = l.y * y.y,
      f = l.z * y.z;
    (n.x += t * (u[0] * w + u[1] * g + u[2] * f)),
      (n.y += t * (u[3] * w + u[4] * g + u[5] * f)),
      (n.z += t * (u[6] * w + u[7] * g + u[8] * f)),
      (o.x += i.x * t),
      (o.y += i.y * t),
      (o.z += i.z * t),
...
z.DYNAMIC = mt.DYNAMIC;
z.STATIC = mt.STATIC;
z.KINEMATIC = mt.KINEMATIC;
z.AWAKE = Ut.AWAKE;
z.SLEEPY = Ut.SLEEPY;
z.SLEEPING = Ut.SLEEPING;
z.wakeupEvent = { type: "wakeup" };
z.sleepyEvent = { type: "sleepy" };
z.sleepEvent = { type: "sleep" };
const Je = new a(),
  Qe = new j(),
  ts = new K(),
  es = new Z(),
...
class ds {
  ...
  needBroadphaseCollision(t, e) {
    return !(
      ...
      ((t.type & z.STATIC || t.sleepState === z.SLEEPING) &&
        (e.type & z.STATIC || e.sleepState === z.SLEEPING))
    );
  }
...
let xe, be, Ee, Ce, Ae, Te, Se;
const Yt = { CLOSEST: 1, ANY: 2, ALL: 4 };
xe = I.types.SPHERE;
be = I.types.PLANE;
Ee = I.types.BOX;
Ce = I.types.CYLINDER;
Ae = I.types.CONVEXPOLYHEDRON;
Te = I.types.HEIGHTFIELD;
Se = I.types.TRIMESH;
class W {
  get [xe]() {
  ...
  _intersectPlane(t, e, s, i, n) {
    ...
    o.vsub(s, u);
    const g = -c.dot(u) / m;
    l.scale(g, y), o.vadd(y, w), this.reportIntersection(c, w, n, i, -1);
  }
  getAABB(t) {
      ...
      for (let u = c; u < p; u++) {
        ...
        if ((t.getAabbAtIndex(m, u, h), !!h.overlapsRay(o))) {
          if (
            ...
            O.pointToWorldFrame(s, e, t.pillarOffset, Tt),
            this._intersectConvex(t.pillarConvex, e, Tt, i, n, ne),
            this.result.shouldStop)
          )
            return;
  ...
  _intersectConvex(t, e, s, i, n, o) {
    const r = Cs,
      ...
      y = this.to,
      w = u.distanceTo(y),
      g = c ? c.length : d.length,
      f = this.result;
    for (let b = 0; !f.shouldStop && b < g; b++) {
      const E = c ? c[b] : b,
        S = d[E],
        k = h[E],
        N = e,
        C = s;
      l.copy(p[S[0]]), N.vmult(l, l), l.vadd(C, l), l.vsub(u, l), N.vmult(k, r);
      const A = m.dot(r);
      ...
      if (!(B < 0)) {
        m.scale(B, Y),
          ...
          N.vmult(X, X),
          C.vadd(X, X);
        for (let F = 1; !f.shouldStop && F < S.length - 1; F++) {
          Q.copy(p[S[F]]),
            tt.copy(p[S[F + 1]]),
            N.vmult(Q, Q),
            N.vmult(tt, tt),
  ...
  _intersectTrimesh(t, e, s, i, n, o) {
    ...
    for (let S = 0, k = l.length; !this.result.shouldStop && S !== k; S++) {
      const N = l[S];
...
function zs(R, t, e) {
  e.vsub(R, at);
  const s = at.dot(t);
  return t.scale(s, St), St.vadd(R, St), e.distanceTo(St);
}
class Ns {
  static defaults(t, e) {
    t === void 0 && (t = {});
...
class Rs extends Ct {
  ...
  computeB(t) {
    ...
    const f = g.dot(u),
      ...
      E = b * h.dot(g) - b * d.dot(g) + m.dot(c) - p.dot(l),
      S = this.computeGiMf();
    return -f * e - E * s - t * S;
  }
...
class Xs extends Ks {
  ...
  solve(t, e) {
    ...
    const g = Zs,
      f = Js,
      b = $s;
    (g.length = r), (f.length = r), (b.length = r);
    for (let E = 0; E !== r; E++) {
      const S = o[E];
      (b[E] = 0), (f[E] = S.computeB(d)), (g[E] = 1 / S.computeC());
    }
    if (r !== 0) {
      for (let k = 0; k !== c; k++) {
        const N = l[k],
...
const _ = {
  sphereSphere: I.types.SPHERE,
  spherePlane: I.types.SPHERE | I.types.PLANE,
  boxBox: I.types.BOX | I.types.BOX,
  sphereBox: I.types.SPHERE | I.types.BOX,
  planeBox: I.types.PLANE | I.types.BOX,
  convexConvex: I.types.CONVEXPOLYHEDRON,
  sphereConvex: I.types.SPHERE | I.types.CONVEXPOLYHEDRON,
  planeConvex: I.types.PLANE | I.types.CONVEXPOLYHEDRON,
  boxConvex: I.types.BOX | I.types.CONVEXPOLYHEDRON,
  sphereHeightfield: I.types.SPHERE | I.types.HEIGHTFIELD,
  boxHeightfield: I.types.BOX | I.types.HEIGHTFIELD,
  convexHeightfield: I.types.CONVEXPOLYHEDRON | I.types.HEIGHTFIELD,
  sphereParticle: I.types.PARTICLE | I.types.SPHERE,
  planeParticle: I.types.PLANE | I.types.PARTICLE,
  boxParticle: I.types.BOX | I.types.PARTICLE,
  convexParticle: I.types.PARTICLE | I.types.CONVEXPOLYHEDRON,
  cylinderCylinder: I.types.CYLINDER,
  sphereCylinder: I.types.SPHERE | I.types.CYLINDER,
  planeCylinder: I.types.PLANE | I.types.CYLINDER,
  boxCylinder: I.types.BOX | I.types.CYLINDER,
  convexCylinder: I.types.CONVEXPOLYHEDRON | I.types.CYLINDER,
  heightfieldCylinder: I.types.HEIGHTFIELD | I.types.CYLINDER,
  particleCylinder: I.types.PARTICLE | I.types.CYLINDER,
  sphereTrimesh: I.types.SPHERE | I.types.TRIMESH,
  planeTrimesh: I.types.PLANE | I.types.TRIMESH,
};
class ei {
  get [_.sphereSphere]() {
  ...
  getContacts(t, e, s, i, n, o, r) {
    ...
    for (let h = 0, m = t.length; h !== m; h++) {
      ...
      const g =
        (u.type & z.KINEMATIC && y.type & z.STATIC) ||
        (u.type & z.STATIC && y.type & z.KINEMATIC) ||
        (u.type & z.KINEMATIC && y.type & z.KINEMATIC);
      for (let f = 0; f < u.shapes.length; f++) {
        ...
        for (let E = 0; E < y.shapes.length; E++) {
          ...
          if (
            !(
              b.collisionFilterMask & S.collisionFilterGroup &&
              S.collisionFilterMask & b.collisionFilterGroup
            ) ||
            d.distanceTo(p) > b.boundingSphereRadius + S.boundingSphereRadius
          )
            continue;
          let k = null;
          b.material &&
            S.material &&
            (k = s.getContactMaterial(b.material, S.material) || null),
            (this.currentContactMaterial = k || w || s.defaultContactMaterial);
          const N = b.type | S.type,
            C = this[N];
          if (C) {
            let A = !1;
            b.type < S.type
              ? (A = C.call(this, b, S, d, p, l, c, u, y, b, S, g))
              : (A = C.call(this, S, b, p, d, c, l, y, u, b, S, g)),
              A &&
                g &&
                (s.shapeOverlapKeeper.set(b.id, S.id),
    ...
    for (let x = 0; x !== T && !y; x++)
      for (let L = 0; L !== T && !y; L++)
        if (x % 3 !== L % 3) {
          ...
          let q = 0;
          for (; q === x % 3 || q === L % 3; ) q++;
          P.copy(s), P.vsub(v, P), P.vsub(F, P), P.vsub(i, P);
          const U = Math.abs(H),
            D = P.length();
          if (U < m[q].length() && D < u) {
            if (p) return !0;
  ...
  sphereConvex(t, e, s, i, n, o, r, l, c, d, p) {
    ...
    for (let f = 0; f !== y.length; f++) {
      ...
      const S = qi;
      if ((E.vsub(s, S), S.lengthSquared() < w * w)) {
        if (p) return !0;
        g = !0;
    ...
    for (let f = 0, b = u.length; f !== b && g === !1; f++) {
      const E = m[f],
        S = u[f],
        k = _i;
      o.vmult(E, k);
      const N = ji;
      o.vmult(y[S[0]], N), N.vadd(i, N);
      const C = Wi;
      ...
      if ((s.vsub(N, F), B < 0 && F.dot(k) > 0)) {
        ...
        for (let v = 0, P = S.length; v !== P; v++) {
          const T = h.get();
          o.vmult(y[S[v]], T), i.vadd(T, T), M.push(T);
        }
        if (Pi(M, k, s)) {
          if (p) return !0;
          g = !0;
          const v = this.createContactEquation(r, l, t, e, c, d);
          k.scale(-w, v.ri), k.negate(v.ni);
          const P = h.get();
          k.scale(-B, P);
          const T = h.get();
          k.scale(-w, T),
          ...
          for (let x = 0, L = M.length; x !== L; x++) h.release(M[x]);
          return;
        } else
          for (let v = 0; v !== S.length; v++) {
            const P = h.get(),
              T = h.get();
            o.vmult(y[S[(v + 1) % S.length]], P),
              o.vmult(y[S[(v + 2) % S.length]], T),
              i.vadd(P, P),
              i.vadd(T, T);
            const x = Li;
            T.vsub(P, x);
            ...
            if (
              ...
              H.vsub(i, G.rj),
                ...
                this.result.push(G),
                this.createFrictionEquationsFromContact(G, this.frictionResult);
              for (let ht = 0, At = M.length; ht !== At; ht++) h.release(M[ht]);
              h.release(P),
                h.release(T),
                h.release(H),
                h.release(D),
        ...
        for (let v = 0, P = M.length; v !== P; v++) h.release(M[v]);
      }
    }
  }
  ...
  sphereHeightfield(t, e, s, i, n, o, r, l, c, d, p) {
    ...
    let g = Math.floor((w.x - m) / u) - 1,
      f = Math.ceil((w.x + m) / u) + 1,
      b = Math.floor((w.y - m) / u) - 1,
      E = Math.ceil((w.y + m) / u) + 1;
    if (f < 0 || E < 0 || g > h.length || b > h[0].length) return;
    g < 0 && (g = 0),
      f < 0 && (f = 0),
      b < 0 && (b = 0),
      E < 0 && (E = 0),
  ...
  convexHeightfield(t, e, s, i, n, o, r, l, c, d, p) {
    const h = e.data,
      ...
      w = ln,
      g = rn;
    O.pointToLocalFrame(i, o, s, g);
    let f = Math.floor((g.x - u) / m) - 1,
      b = Math.ceil((g.x + u) / m) + 1,
      E = Math.floor((g.y - u) / m) - 1,
      S = Math.ceil((g.y + u) / m) + 1;
    if (b < 0 || S < 0 || f > h.length || E > h[0].length) return;
    f < 0 && (f = 0),
      b < 0 && (b = 0),
      E < 0 && (E = 0),
      S < 0 && (S = 0),
      ...
      S >= h[0].length && (S = h[0].length - 1),
      E >= h[0].length && (E = h[0].length - 1);
    const k = [];
    e.getRectMinMax(f, E, b, S, k);
    const N = k[0],
      C = k[1];
    if (!(g.z - u > C || g.z + u < N))
      for (let A = f; A < b; A++)
  ...
  convexParticle(t, e, s, i, n, o, r, l, c, d, p) {
    ...
    if (
      ...
      for (let g = 0, f = t.faces.length; g !== f; g++) {
        const b = [t.worldVertices[t.faces[g][0]]],
          E = t.worldFaceNormals[g];
        i.vsub(b[0], me);
        const S = -E.dot(me);
        if (y === null || Math.abs(S) < Math.abs(y)) {
          if (p) return !0;
          (y = S), (h = g), m.copy(E);
        }
      }
      if (h !== -1) {
        const g = this.createContactEquation(l, r, e, t, c, d);
        m.scale(y, u),
          u.vadd(i, u),
          u.vsub(s, u),
          g.rj.copy(u),
  ...
  sphereTrimesh(t, e, s, i, n, o, r, l, c, d, p) {
    ...
    f.lowerBound.set(w.x - k, w.y - k, w.z - k),
      ...
      e.getTrianglesInAABB(f, S);
    const N = di,
      C = t.radius * t.radius;
    for (let v = 0; v < S.length; v++)
      for (let P = 0; P < 3; P++)
        if (
          (e.getVertex(e.indices[S[v] * 3 + P], N),
          N.vsub(w, E),
          E.lengthSquared() <= C)
        ) {
          if ((b.copy(N), O.pointToWorldFrame(i, o, b, N), N.vsub(s, E), p))
            return !0;
          let T = this.createContactEquation(r, l, t, e, c, d);
          T.ni.copy(E),
            T.ni.normalize(),
            T.ri.copy(T.ni),
            T.ri.scale(t.radius, T.ri),
            T.ri.vadd(s, T.ri),
            T.ri.vsub(r.position, T.ri),
            T.rj.copy(N),
            T.rj.vsub(l.position, T.rj),
            this.result.push(T),
            this.createFrictionEquationsFromContact(T, this.frictionResult);
        }
    for (let v = 0; v < S.length; v++)
      for (let P = 0; P < 3; P++) {
        e.getVertex(e.indices[S[v] * 3 + P], h),
          e.getVertex(e.indices[S[v] * 3 + ((P + 1) % 3)], m),
          m.vsub(h, u),
          w.vsub(m, g);
        const T = g.dot(u);
        w.vsub(h, g);
        ...
        if (
          ...
          g.vsub(w, H.ni),
            ...
            H.ri.vadd(s, H.ri),
            H.ri.vsub(r.position, H.ri),
            O.pointToWorldFrame(i, o, g, g),
            g.vsub(l.position, H.rj),
    ...
    const A = vi,
      ...
      M = ci;
    for (let v = 0, P = S.length; v !== P; v++) {
      e.getTriangleVertices(S[v], A, B, F), e.getNormal(S[v], M), w.vsub(A, g);
      let T = g.dot(M);
      if (
        (M.scale(T, g),
        w.vsub(g, g),
        (T = g.distanceTo(w)),
        W.pointInTriangle(g, A, B, F) && T < t.radius)
      ) {
        if (p) return !0;
...
const Bt = new a(),
  ...
  Bi = new a(),
  Ii = new a(),
  Mi = [new a(), new a(), new a(), new a(), new a(), new a()],
  zi = new a(),
  Ni = new a(),
  Fi = new a(),
  Ri = new a(),
...
class un extends ve {
  constructor(t) {
    t === void 0 && (t = {}),
      ...
      (this.defaultContactMaterial = new zt(
  ...
  internalStep(t) {
    ...
    for (c && (h = V.now()), f = 0; f !== n; f++) {
      ...
      if (v.type === p) {
        const P = v.force,
          T = v.mass;
        (P.x += T * y), (P.y += T * w), (P.z += T * g);
      }
    }
    for (let v = 0, P = this.subsystems.length; v !== P; v++)
    ...
    for (f = 0; f !== b; f++) {
      ...
      if (!v.collideConnected)
        for (let P = s.length - 1; P >= 0; P -= 1)
          ((v.bodyA === s[P] && v.bodyB === i[P]) ||
            (v.bodyB === s[P] && v.bodyA === i[P])) &&
            (s.splice(P, 1), i.splice(P, 1));
    }
    this.collisionMatrixTick(), c && (h = V.now());
    const E = fn,
      S = e.length;
    for (f = 0; f !== S; f++) E.push(e[f]);
    e.length = 0;
    ...
    for (let v = 0; v !== N; v++) {
      ...
      let q;
      if (
        (T.material && x.material
          ? (q =
              this.getContactMaterial(T.material, x.material) ||
              this.defaultContactMaterial)
          : (q = this.defaultContactMaterial),
        q.friction,
        T.material &&
          x.material &&
          (T.material.friction >= 0 &&
            x.material.friction >= 0 &&
            T.material.friction * x.material.friction,
          T.material.restitution >= 0 &&
            x.material.restitution >= 0 &&
            (P.restitution = T.material.restitution * x.material.restitution)),
        r.addEquation(P),
        T.allowSleep &&
          T.type === z.DYNAMIC &&
          T.sleepState === z.SLEEPING &&
          x.sleepState === z.AWAKE &&
          x.type !== z.STATIC)
      ) {
        const U =
            x.velocity.lengthSquared() + x.angularVelocity.lengthSquared(),
          D = x.sleepSpeedLimit ** 2;
        U >= D * 2 && (T.wakeUpAfterNarrowphase = !0);
      }
      if (
        x.allowSleep &&
        x.type === z.DYNAMIC &&
        x.sleepState === z.SLEEPING &&
        T.sleepState === z.AWAKE &&
        T.type !== z.STATIC
      ) {
        const U =
            T.velocity.lengthSquared() + T.angularVelocity.lengthSquared(),
          D = T.sleepSpeedLimit ** 2;
        U >= D * 2 && (x.wakeUpAfterNarrowphase = !0);
      }
      this.collisionMatrix.set(T, x, !0),
        this.collisionMatrixPrevious.get(T, x) ||
          ((wt.body = x),
          (wt.contact = P),
          T.dispatchEvent(wt),
          (wt.body = T),
          x.dispatchEvent(wt)),
        this.bodyOverlapKeeper.set(T.id, x.id),
    ...
    for (b = m.length, f = 0; f !== b; f++) {
      const v = m[f];
      v.update();
      for (let P = 0, T = v.equations.length; P !== T; P++) {
        const x = v.equations[P];
        r.addEquation(x);
      }
    }
    ...
    for (f = 0; f !== n; f++) {
      const v = o[f];
      if (v.type & p) {
        const P = C(1 - v.linearDamping, t),
          T = v.velocity;
        T.scale(P, T);
        const x = v.angularVelocity;
        if (x) {
          const L = C(1 - v.angularDamping, t);
          x.scale(L, x);
        }
      }
    }
    ...
    if (this.allowSleep)
      for (M = !1, f = 0; f !== n; f++) {
        const v = o[f];
        v.sleepTick(this.time), v.sleepState !== z.SLEEPING && (M = !0);
      }
    this.hasActiveBodies = M;
  }
  emitContactEvents() {
    ...
    if (((t || e) && this.bodyOverlapKeeper.getDiff(et, st), t)) {
      for (let n = 0, o = et.length; n < o; n += 2)
        (gt.bodyA = this.getBodyById(et[n])),
          (gt.bodyB = this.getBodyById(et[n + 1])),
          this.dispatchEvent(gt);
      gt.bodyA = gt.bodyB = null;
    }
    if (e) {
      for (let n = 0, o = st.length; n < o; n += 2)
        (vt.bodyA = this.getBodyById(st[n])),
          (vt.bodyB = this.getBodyById(st[n + 1])),
...
const pn = { type: "postStep" },
  mn = { type: "preStep" },
  wt = { type: z.COLLIDE_EVENT_NAME, body: null, contact: null },
  fn = [],
  yn = [],
  wn = [],
  gn = [],
  et = [],
  st = [],
  gt = { type: "beginContact", bodyA: null, bodyB: null },
  vt = { type: "endContact", bodyA: null, bodyB: null },
  it = {
...
function vn(R, t, e) {
  ...
  const r = [],
    l = new It({ color: s ?? 65280, wireframe: !0 }),
    c = new a(),
    d = new a(),
    p = new a(),
    h = new j(),
  ...
  function w(C) {
    const A = new Gt(),
      B = [];
    for (let M = 0; M < C.vertices.length; M++) {
      const v = C.vertices[M];
      B.push(v.x, v.y, v.z);
    }
  ...
  function f(C) {
    const A = new Gt(),
      B = C.elementSize || 1,
      F = C.data.flatMap((v, P) => v.flatMap((T, x) => [P * B, x * B, T])),
      M = [];
    for (let v = 0; v < C.data.length - 1; v++)
      for (let P = 0; P < C.data[v].length - 1; P++) {
        const T = C.data[v].length,
          x = v * T + P;
        M.push(x + 1, x + T, x + T + 1), M.push(x + T, x + 1, x);
      }
    return (
      A.setIndex(M),
  ...
  function b(C) {
    ...
    switch (C.type) {
      ...
      case v: {
        const L = new ge(C.radiusTop, C.radiusBottom, C.height, C.numSegments);
  ...
  function S(C, A) {
    ...
    const { geometry: B } = C;
    return (
      (B instanceof Vt && A.type === I.types.SPHERE) ||
      (B instanceof Xt && A.type === I.types.BOX) ||
      (B instanceof Dt && A.type === I.types.PLANE) ||
      (B.id === A.geometryId && A.type === I.types.CYLINDER) ||
      (B.id === A.geometryId && A.type === I.types.CONVEXPOLYHEDRON) ||
      (B.id === A.geometryId && A.type === I.types.TRIMESH) ||
      (B.id === A.geometryId && A.type === I.types.HEIGHTFIELD)
    );
  }
  function k(C, A) {
    let B = r[C],
      F = !1;
    return (
      S(B, A) || (B && R.remove(B), (r[C] = B = b(A)), (F = !0)), E(B, A), F
    );
  }
  function N() {
    const C = r,
      ...
      B = h;
    let F = 0;
    for (const M of t.bodies)
      for (let v = 0; v !== M.shapes.length; v++) {
        const P = M.shapes[v],
          T = k(F, P),
          x = C[F];
        x &&
          (M.quaternion.vmult(M.shapeOffsets[v], A),
          M.position.vadd(A, A),
          M.quaternion.mult(M.shapeOrientations[v], B),
          x.position.copy(A),
          x.quaternion.copy(B),
          T && n instanceof Function && n(M, x, P),
          !T && o instanceof Function && o(M, x, P)),
          F++;
      }
    for (let M = F; M < C.length; M++) {
      const v = C[M];
      v && R.remove(v);
    }
    C.length = F;
...
class xn {
  ...
  CreateGroundMesh() {
    const e = new ke(this.loadingManager).load(
      ...
      s = new $(new Dt(4150, 2e3), new It({ map: e }));
  ...
  CreateGroundBody() {
    const t = new z({ shape: new Et(new a(2e3, 1e-4, 1e3)) });
...
class En {
  constructor(t, e, s, i) {
    (this.player = e),
      ...
      (this.framesElapsed = 0),
      (this.playerCharacter = t.selectedCharacters[i]),
      (this.character = i),
      (this.player1Audio = document.getElementById("player1Audio")),
      (this.player2Audio = document.getElementById("player2Audio"));
  }
  ...
  playerAttackAudio(t) {
    const e =
        this.playerCharacter === "Eve" || this.playerCharacter === "Kachujin",
      s =
        t === "punch"
          ? e
            ? "../resources/Audios/punch-2-37333.mp3"
            : "../resources/Audios/punch-or-kick-sound-effect-1-239696.mp3"
          : e
          ? "../resources/Audios/punch-41105.mp3"
          : "../resources/Audios/punch-or-kick-sound-effect-2-239695.mp3",
      i = this.character === "player1" ? this.player1Audio : this.player2Audio;
    (i.currentTime = 0), (i.src = s), i.play();
  }
  PickObject() {
...
class we {
  constructor({
    ...
    (this.scene = t.scene),
      ...
      (this.animations = {}),
      (this.loader = new Me(this.manager)),
  ...
  loadCannonBodies() {
    Object.keys(this.cannonBodies).forEach((t) => {
      ...
      switch (s) {
        case "Sphere":
          let r = e.size;
          (n = new $(new Vt(r), new It({ wireframe: !0, color: 65280 }))),
            (o = new Us(r)),
            (i = new z({ type: mt.STATIC })),
            i.addShape(o),
            (i.position.y = 10),
        ...
        case "Cylinder":
          let l = e.top,
            c = e.bottom,
            d = e.height;
          (n = new $(new ge(l, c, d), new It({ wireframe: !0, color: 65280 }))),
            (o = new Ys(l, c, d)),
            (i = new z({ type: mt.STATIC })),
            i.addShape(o),
            (i.position.x = 0),
  ...
  onGameLoaded(t, e) {
    (this.control = t),
      ...
      t === "Computer" && (this.AIHandler = new Tn(this, e, this.game)),
      t !== "Keyboard" &&
        t !== "Computer" &&
        ((this.gamePadHandler = new bn(t, this, this.game)),
        (this.control = "Gamepad")),
      this.setCannonBodiessDynamic(),
      (this.AnimationHandler = new En(this.game, this, "Idle", this.player)),
...
class Sn {
  constructor(t) {
    this.timer,
      ...
      this.CountDownTimer,
      (this.game = t),
      (this.miscAudio = document.getElementById("miscAudio")),
  ...
  displayWinner() {
    clearInterval(this.timerId), this.backgroundAudio.pause();
        ...
        this.CountDownTimer > 0 &&
          (this.CountDownTimer > 1
            ? (document.getElementById("displayText").innerText =
                this.CountDownTimer - 1)
            : ((document.getElementById("displayText").innerText = "Fight"),
              (miscAudio.currentTime = 0),
              (miscAudio.src =
                "../resources/Audios/fight-deep-voice-172194.mp3"),
              miscAudio.play())),
        this.CountDownTimer === 0 &&
          (clearInterval(this.timerId),
...
class Pn {
  ...
  Restart() {
    this.game.camera.lookAt(0, 0, 100),
      ...
      (this.game.Utils.CountDownTimer = 4),
      ...
      (document.getElementsByClassName("back")[0].innerText = "Kick[L][3]"),
      (document.getElementById("displayText").innerText =
        this.game.Utils.CountDownTimer - 1),
  ...
  TogglePause() {
    switch (
      ...
      (this.miscAudio.src = "../resources/Audios/menu-click-89198.mp3"),
      this.miscAudio.play(),
      this.gamestate)
    ) {
  ...
  changeSelector(t) {
    (this.gamestate !== this.GAMESTATE.PAUSED &&
      this.gamestate !== this.GAMESTATE.GAMEOVER) ||
      ((this.miscAudio.currentTime = 0),
      (this.miscAudio.src = "../resources/Audios/menu-button-88360.mp3"),
      this.miscAudio.play(),
      t === "right"
          ...
          this.gamestate === this.GAMESTATE.PAUSED
            ...
            : setTimeout(() => {
                typeof window.electronAPI < "u"
                  ? window.electronAPI.navigateTo("SelectCharacter/index.html")
                  : navigateTo("SelectCharacter");
              }, 500);
          break;
        case 3:
          this.gamestate === this.GAMESTATE.PAUSED
  ...
  navigateTo(t) {
    const e = window.location.href,
      ...
      i = s.substring(0, s.lastIndexOf("/"));
    window.location.pathname = `${i}/${t}/`;
  }
}
class kn {
    ...
    (this.mode = localStorage.getItem("Mode")),
      ...
      this.playerControlers === null &&
        (typeof window.electronAPI < "u"
          ...
          : this.navigateTo("SelectController")),
      this.selectedCharacters === null &&
        (typeof window.electronAPI < "u"
          ? window.electronAPI.navigateTo("SelectCharacter/index.html")
          : this.navigateTo("SelectCharacter")),
      (this.gameWidth = t),
      (this.gameHeight = e),
      this.init(),
  ...
  init() {
    ...
    (this.scene.background = e),
      (this.cannonDebugger = new vn(this.scene, this.world, {
        color: 16711680,
      })),
      (this.worldPhysics = new xn(this)),
      (this.Utils = new Sn(this)),
